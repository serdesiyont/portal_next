...
// Remove DropdownMenu imports since we're not using dropdown for theme toggle anymore
    ...
    <div className="h-screen bg-background text-foreground flex flex-col">
      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50 flex-shrink-0">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          {/* Navigation - Remove this section from header */}
          <div className="hidden md:flex items-center gap-6">{/* This section will be moved below */}</div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-64 border-r bg-muted/30 flex-shrink-0 overflow-y-auto sticky top-24">
          <div className="p-4">
            {/* Overview Section */}
            <div className="mb-6">
          ...
          <div className="p-8 max-w-4xl">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              <p className="text-lg text-muted-foreground mb-6">
                Chroma is an AI-native open-source vector database. It comes with everything you need to get started
                built-in, and runs on your machine.
              </p>
                  ...
                  <div className="bg-slate-950 dark:bg-slate-900 rounded-lg p-4 border">
                    ...
                    <pre className="text-sm overflow-x-auto">
                      <code className="font-mono leading-relaxed">
                        ...
                        <span className="text-yellow-300">collection</span> <span className="text-pink-400">=</span>{" "}
                        <span className="text-purple-400">await</span> <span className="text-yellow-300">client</span>
                        <span className="text-white">.</span>
              ...
              <p className="text-muted-foreground mb-4">
                The Chroma client is your main interface to interact with Chroma. You can create a client that connects
                to a local Chroma instance or to Chroma Cloud.
              </p>
              ...
              <p className="text-muted-foreground mb-4">
                Once you have a collection, you can add documents to it. Documents can include text, metadata, and
                embeddings.
              </p>
